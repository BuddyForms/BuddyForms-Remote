...
{
var cssLink = $("
<link rel='stylesheet' type='text/css' href='<?php echo BUDDYFORMS_REMOTE_PLUGIN_URL . 'assets/toggle.css'; ?>'>");
$("head").append(cssLink);

/* Set 'height' and 'width' according to the content type */
var iframeContent = '' +
'
<div id="bf-remote-tab">
	<div id="bf-remote-container">' +
		'
	...
	<a class="bf-burger"><span>Toggle</span></a></div>';
